                        ...
                        {(vars.vh - vars.sh) > -50 &&
                            <div>
                                <Delay inline={true} delay={500}>
                                    <a target='_blank' className='shadow hovShade mr-2 slideIn panel' href="https://github.com/Msugh623">
                                ...
                                <Delay inline={true} delay={800}>
                                    <a target='_blank' className='shadow hovShade mr-2 slideRight panel' href="mailto:iternenge469@gmail.com"><span className="bi bi-twitter"> <BiEnvelope className='icon text-2xl' />
                                        <div className="text">
                                            Email
                                        </div>
                                    </span>
                                ...
                                <Delay inline={true} delay={900}>
                                    <a target='_blank' className='shadow hovShade mr-2 slideRight panel' href="https://wa.me/2348121667177"><span className="bi bi-facebook"> < FaWhatsapp className='icon text-2xl' />
                                        <div className="text">
                                            Whatsapp
                                        </div>
                                    </span></a>
                                ...
                                <Delay inline={true} delay={1000}>
                                    <a target='_blank' className='shadow hovShade mr-2 slideRight panel' href="https://ng.linkedin.com/in/chia-ernest-b923962a9"><span className="bi bi-instagram"><FaLinkedin className='text-2xl icon' />
                                        <div className="text">
                                            Linkedin
                                        </div>
                                    </span></a>
