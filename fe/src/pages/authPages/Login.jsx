...
const Login = () => {
    ...
    return (
        <div className='container pt-5 darkTheme'>
            <div className="row">
                <form onSubmit={login} className='col-10 col-sm-9 col-md-7 col-lg-5 shadow-md panel rounded mx-auto slideUp'>
                    <div className="d-flex">
                        <h3 className="m-auto my-3">
                            <Link to={'/'}>
                                <LazyLoadImage effect='opacity' placeholder={<PlaceHolder />} src="sprintetName.png" height={'60px'} alt="" /> Login
                            </Link>
                        </h3>
                    </div>
